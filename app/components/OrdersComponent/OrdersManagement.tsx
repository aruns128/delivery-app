                        ...
                        <tbody>
                            {orders.map((order: any, idx: number) => {
                                ...
                                return (
                                    <tr
                                        key={order._id}
                                        className={`transition-colors h-full ${idx % 2 === 0 ? "bg-white" : "bg-gray-50"
                                            } hover:bg-blue-50`}
                                    >
                                        ...
                                        <td className="p-3">
                                            {order.status === "Pending" && (
                                                <>
                                                    {/* Desktop Buttons */}
                                                    <div className="hidden sm:flex gap-2 h-full items-center justify-center">
                                                        <button
                                                    ...
                                                    {/* Mobile Icons */}
                                                    <div className="flex sm:hidden gap-2 h-full items-center justify-center">
                                                        <button
